...
TAXONOMY="$DATA_DIR/bac120_taxonomy_r232.tsv"
...
if [ ! -f "$TAXONOMY" ]; then
  (cd "$DATA_DIR" && wget https://data.gtdb.aau.ecogenomic.org/releases/release232/232.0/bac120_taxonomy_r232.tsv.gz && gunzip bac120_taxonomy_r232.tsv.gz)
fi
